...
```bash
git remote add encore encore://force-personal-development-kcc2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/force-personal-development-kcc2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/force-personal-development-kcc2/settings/integrations/github)

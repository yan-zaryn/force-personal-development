...
import { updateGrowthItemStatus as api_force_update_growth_item_status_updateGrowthItemStatus } from "~backend/force/update_growth_item_status";
...
export namespace force {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.mentalModelsCoach = this.mentalModelsCoach.bind(this)
            this.saveReflection = this.saveReflection.bind(this)
            this.saveSkillAssessment = this.saveSkillAssessment.bind(this)
            this.updateGrowthItemStatus = this.updateGrowthItemStatus.bind(this)
        }
        ...
        public async createUser(params: RequestType<typeof api_force_create_user_createUser>): Promise<ResponseType<typeof api_force_create_user_createUser>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_force_create_user_createUser>
        }
        ...
        public async getUser(params: { id: number }): Promise<ResponseType<typeof api_force_get_user_getUser>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_force_get_user_getUser>
        }
